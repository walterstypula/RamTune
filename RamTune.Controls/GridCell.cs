...
namespace RamTune.Controls
{
    ...
    [TemplatePart(Name = GridCell.PART_Label, Type = typeof(Label))]
    public class GridCell : SelectionBase
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            var text = base.GetTemplateChild(GridCell.PART_Label) as Label;

            if (text != null)
            {
                ControlsHelper.CreateControlBinding(text, this, "Text", Label.ContentProperty, BindingMode.TwoWay);
            }
